...
{
    public class StorageFolderCollectionType<T> : BaseCollectionType<T> where T : IStorageFolder
    {
        private T folder;
        private ObservableCollection<StorageFileCollectionType<StorageFile>> fileCollection;
        private string path;
        private string folderName;

        public StorageFolderCollectionType() { }

        public StorageFolderCollectionType(T folder, bool isChecked = false)
        {
            this.folder = folder;
        ...
        public ObservableCollection<StorageFileCollectionType<StorageFile>> FileCollection
        {
